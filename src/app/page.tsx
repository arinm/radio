    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 pt-6 sm:pt-10">
        ...
        <p className="mt-2 text-base text-muted-foreground sm:text-lg">
          Peste {stationCount} posturi de radio romanesti live. Muzica, stiri, sport si divertisment — 24/7, gratuit.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-8">
        <h2 className="mb-4 text-xl font-bold text-foreground sm:text-2xl">Genuri populare de radio</h2>
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
          {Object.entries(GENRES).map(([slug, genre]) => (
            <Link
              key={slug}
              href={`/radio-genuri/${slug}`}
              className="rounded-lg border border-border bg-card px-4 py-3 text-center text-sm font-medium text-foreground transition-colors hover:border-primary hover:bg-primary/5"
            >
              {genre.nameRo}
            </Link>
          ))}
        ...
        <div className="mx-auto max-w-7xl px-4 py-12">
          ...
          <div className="mt-4 max-w-3xl space-y-3 text-sm leading-relaxed text-muted-foreground">
            <p>
              ...
              Avem peste {stationCount} posturi de radio romanesti disponibile pentru streaming live.
            </p>
            <p>
            ...
            <p>
              Descopera posturi de radio din cele mai populare genuri muzicale din Romania:
              radio pop cu hiturile momentului, radio rock cu muzica clasica si alternativa,
              radio manele cu cele mai noi piese, radio muzica populara si folclor romanesc,
              radio dance si electronica, radio hip-hop si rap, radio jazz si blues,
              radio retro cu hituri din anii 80 si 90, si posturi de stiri cu informatii in timp real.
            </p>
            ...
            <p>
              ...
              Brasov, Craiova, Galati, Sibiu si din toate regiunile Romaniei. Indiferent unde
              te afli, poti asculta radioul tau preferat online, gratuit si fara intreruperi.
            </p>
            ...
            <p>
              Platforma noastra ofera streaming radio de inalta calitate, fara reclame proprii
              si fara a fi nevoie de cont sau abonament. Interfata este simpla, rapida si
              optimizata pentru orice dispozitiv. Poti salva posturile favorite, naviga pe
              genuri muzicale si descoperi posturi noi recomandate. Folosim tehnologie moderna
              pentru a asigura o experienta de ascultare fluida si placuta.
            </p>
          </div>
        </div>
      </section>
